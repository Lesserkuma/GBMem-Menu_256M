  ...
  el.innerHTML =
    ...
    '<div class="flash-rules">' +
      ...
      '<ul>' +
        ...
        '<li>Each 2 MiB flash block maps to either an SRAM block of 32 KiB. In blocks 0, 1, 2, 3, 8, 9, 10 and 11, the block can also be divided into two 8 KiB SRAM slots (up to 24 slots total).</li>' +
